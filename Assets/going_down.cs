...
public class going_down : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        else
        {
            ...
            RaycastHit2D hit = Physics2D.Raycast(transform.position + new Vector3(0f,-offset,0f), Vector2.down, stopDistance, layerMask);
    ...
    //     Gizmos.DrawRay(transform.position + new Vector3(0f,-offset,0f), Vector2.down * stopDistance);
    // }
}
