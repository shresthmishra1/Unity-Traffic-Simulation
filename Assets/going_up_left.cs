...
public class going_up_left : MonoBehaviour
{
    float speed = 10f;
    ...
    void Start()
    {
        ...
        GameObject[] waypointObjects = GameObject.FindGameObjectsWithTag("UpLeftWaypoint");
    ...
    void FixedUpdate()
    {
        ...
        offset = direction * size.y * scale.y * 0.8f + 0.8f * direction;
        int layerNum = 0;
